...
<?php do_action( 'tribe_ce_before_event_list_top_buttons' ); ?>
<?php
	echo '<div id="add-new"><a href="' .$this->getUrl( 'add' ) . '" class="button">' . apply_filters( 'tribe_ce_add_event_button_text', __( 'Add New','tribe-events-community' ) ) . '</a></div>';
	?>
	<div class="table-menu-wrapper">
			<a href="#" class="table-menu-btn button"><?php echo apply_filters( 'tribe_ce_event_list_display_button_text', __( 'Display', 'tribe-events-community' ) ); ?></a>
...
?>
		<?php do_action( 'tribe_ce_before_event_list_table' ); ?>

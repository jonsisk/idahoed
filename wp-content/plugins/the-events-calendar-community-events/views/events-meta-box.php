...
<div id='eventDetails' class="inside eventForm bubble">
   <?php do_action( 'tribe_events_detail_top', $postId, true ) ?>
	...
	<div class="tribe_sectionheader" style="padding: 6px 6px 0 0; font-size: 11px; margin: 0 10px;"><h4><?php _e( 'Location Details', 'tribe-events-community' ); ?></h4></div>
   ...
   <?php do_action( 'tribe_after_location_details', $postId ); ?>
	<table id="event_organizer" class="eventtable">
			<tr>
				<td colspan="2" class="tribe_sectionheader"><h4><?php _e( 'Organizer Details', 'tribe-events-community' ); ?></h4></td>
			</tr>
	...
	<table id="event_cost" class="eventtable">
		<tr>
			<td colspan="2" class="tribe_sectionheader"><h4><?php _e( 'Cost', 'tribe-events-community' ); ?></h4></td>
		</tr>
		<tr>
			<td><?php _e( 'Cost:','tribe-events-community' ); ?></td>
			<td><input tabindex="<?php $this->tabIndex(); ?>" type='text' id='EventCost' name='EventCost' size='6' value='<?php echo ( isset( $_POST['EventCost'] ) ) ? esc_attr( $_POST['EventCost'] ) : ( tribe_get_event_meta( $postId, '_EventCost', true ) ) ? tribe_get_cost( $postId ) : '0'; ?>' /></td>
		</tr>
		<tr>
			<td></td>

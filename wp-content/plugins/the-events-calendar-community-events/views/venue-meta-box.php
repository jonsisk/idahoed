...
<tr class="venue">
	...
	<td><input tabindex="<?php $this->tabIndex(); ?>" id="StateProvinceText" name="venue[Province]" type='text' size='25' value='<?php echo ( isset($_VenueProvince) && $_VenueProvince != '' && $_VenueProvince != -1 ) ? esc_attr($_VenueProvince) : esc_attr(''); ?>' />

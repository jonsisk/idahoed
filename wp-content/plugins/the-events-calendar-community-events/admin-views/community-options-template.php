...
$communityTab = array(
	...
	'fields' => array(
		...
		'info-box-description' => array(
			'type' => 'html',
			'html' => '<p>' . __('Community Events enables front end event submission on your site. Whether soliciting contributions from anonymous users or registered members, you have complete editorial control over what makes it onto the calendar.</p><p>Before jumping into it, make sure you\'ve checked out our <a href="http://tri.be/support/documentation/community-events-new-user-primer/">Community Events new user primer</a>: it features both videos and written steps covering how the plugin works and what the different options can do to enhance your site.', 'tribe-events-community') . '</p>',
		),
		'info-end' => array(
			'type' => 'html',
			'html' => '</div>',
		...
		'communityRewriteSlug' => array(
			...
			'size' => 'medium',
			'default' => 'community',
			'tooltip' => __( 'The slug used for building the community events URL - it is appended to the main events slug.', 'tribe-events-community' ),
			'parent_option' => TribeCommunityEvents::OPTIONNAME,
		),
	...
	'member-heading' => array(
		...
		'member-info' => array(
			'type' => 'html',
			'html' => '<p><b>'. __( 'Allow logged in users to:', 'tribe-events-community' ) .'</b></p>',
		),

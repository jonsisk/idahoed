			...
			<div class="row">
				<div id="main" class="col-lg-9 col-sm-8">
					...
					<div id="featured" class="wrapper">
						<a href="/the-edge-blog"><img id="the_edge_header" src="<?php echo get_stylesheet_directory_uri(); ?>/images/the-edge-header1.png" /></a>
						<div class="row">
						
						<?php get_template_part('part', 'featured') ?>
						
						</div>
						<h4 style="text-align:right;padding-right:10px"><a href="/the-edge-blog">More from the EDge &raquo; </a></h4>
					</div>
					<?php endif; ?>

<?php
/*
Template Name: 2014 Election Results
*/

get_header();
?>

<script src="/2014election/js/highcharts.js"></script>
<script src="/2014election/js/modules/exporting.js"></script>
<style>
.electiongraph {
	float: left;
	width: 350px;
...
.twobars { height: 100px; }
.fourbars { height: 200px; }
</style>
<script type='text/javascript'>
function loadElectionGraphs() {
	jQuery('#election_results_graphs').load('/2014election/ied_electiongraphs.php')
	setTimeout(loadElectionGraphs, 5000)
	};
...
<div id="innerContent" style="width:970px;margin:0;">
	<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
	<h1 class="singlePageTitle"><?php the_title(); ?></h1>

	<div id="innerLeft" style="width:970px;margin:0;">	
		<div class="post">
			...
			<?php 		
				...
				// Display Election Graphs
				echo '<div id=election_results_graphs></div>';
